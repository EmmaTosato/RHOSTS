...
Sample bash scripts to launch the code with different options can be found in the `src/launchers/` directory, where you will also find a sample multivariate time series generated by the Coupled Lattice Map code found in the folder "Kaneko_CLM". Finally, Python notebooks highlighting some simple analyses are present in the `Notebooks/` folder
